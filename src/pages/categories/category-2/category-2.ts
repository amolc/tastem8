...
/*
  Generated class for the Category2 page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-category-2',
  templateUrl: 'category-2.html',
...
export class Category2Page {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad Category2Page');
  }

  loadRecipes(){
    this.apiAuthentication.loadCategory2()
    .then(data => {
      this.api = data;
    });
  } 
